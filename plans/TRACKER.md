...
| Step | File | Description | Status | Notes |
|------|------|-------------|--------|-------|
| 05 | [STEP05.md](STEP05.md) | Provider trait + Anthropic streaming | `[ ]` | Depends on: 01–04 |
| 06 | [STEP06.md](STEP06.md) | StreamProcessor (text + thinking parsing) | `[ ]` | Depends on: 05 |
...
| Step | File | Description | Status | Notes |
|------|------|-------------|--------|-------|
| 11 | [STEP11.md](STEP11.md) | ToolHandler trait + registry | `[ ]` | Depends on: 01–04 |
...
| Step | File | Description | Status | Notes |
|------|------|-------------|--------|-------|
| 17 | [STEP17.md](STEP17.md) | Plan/Act mode switching | `[ ]` | Depends on: 16, 07, 11 |
