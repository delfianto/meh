...
| 24 | [STEP24.md](STEP24.md) | Task history (save/resume) | `[x]` | PR #21 |
...
| 42 | [STEP42.md](STEP42.md) | jiter JSON parser, async TUI, task abort safety | `[ ]` | Depends on: 41 |
